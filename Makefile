...
# Example: make spdx NAME="Jiri Vyskocil" FILES="src/terok/new_file.py"
spdx:
ifndef NAME
	$(error NAME is required — use the real name of the copyright holder, e.g. make spdx NAME="Jiri Vyskocil" FILES="src/terok/new_file.py")
endif
