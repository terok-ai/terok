...
if TYPE_CHECKING:
    ...
    from terok.lib.api.task import (
        ...
        dns_tier_label as dns_tier_label,
...
_LAZY: dict[str, str] = {
    ...
    "SetupStatus": "terok.lib.api.setup",
    ...
    "dns_tier_label": "terok.lib.api.task",
    ...
    "check_setup": "terok.lib.api.setup",
