...
def _build_project_config(
    ...
    return ProjectConfig(
        ...
        hook_post_start=raw.run.hooks.post_start or get_global_hooks()[0],
        hook_post_ready=raw.run.hooks.post_ready or get_global_hooks()[1],
        hook_pre_stop=raw.run.hooks.pre_stop or get_global_hooks()[2],
